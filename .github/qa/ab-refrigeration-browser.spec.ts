...
test('AB Refrigeration desktop bilingual demo and lead flow work without external side effects', async ({ page }) => {
  ...
  await expect(page.getByText('AB Refrigeration Heating & Cooling LLC').first()).toBeVisible();
...
test('AB Refrigeration mobile menu and language switch work', async ({ page }) => {
