...
test('Pro Cool Heating & Air desktop bilingual demo and lead flow work without external side effects', async ({ page }) => {
  ...
  await expect(page.getByText('Pro Cool Heating & Air').first()).toBeVisible();
...
test('Pro Cool Heating & Air mobile menu and language switch work', async ({ page }) => {
