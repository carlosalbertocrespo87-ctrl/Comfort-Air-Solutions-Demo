...
test("Bob's Heating & Air desktop bilingual demo and lead flow work without external side effects", async ({ page }) => {
  ...
  await expect(page.getByText("Bob's Heating & Air").first()).toBeVisible();
...
test("Bob's Heating & Air mobile menu and language switch work", async ({ page }) => {
