...
test('ASAP desktop bilingual demo and lead flow work without external side effects', async ({ page }) => {
  ...
  await expect(page.getByText('ASAP Heating & Air Conditioning').first()).toBeVisible();
...
test('ASAP mobile menu and language switch work', async ({ page }) => {
