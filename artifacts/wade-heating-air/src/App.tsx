...
const translations = {
  en: {
    ...
    hero: {
      eyebrow: "Georgia's West Metro comfort team",
      ...
      items: [
        {
          id: "ac",
          title: "AC Repair",
          copy: "Reliable HVAC repairs across Georgia's West Metro Area. We find the root cause and explain it plainly.",
          detail:
    ...
    chat: {
      assistantTitle: "Wade Heating & Air AI Assistant",
      assistantSubtitle: "Here to point you in the right direction",
      greeting:
        "Hi there — I’m Wade Heating & Air’s virtual assistant. I can collect a few details for our team. I won’t estimate pricing or promise a technician time, but I can make your next step easier.",
  ...
  es: {
    ...
    why: {
      eyebrow: "Por qué Wade Heating & Air",
    ...
    chat: {
      assistantTitle: "Asistente IA Wade Heating & Air",
      assistantSubtitle: "Aquí para guiarte en la dirección correcta",
      greeting:
        "Hola — soy el asistente virtual de Wade Heating & Air. Puedo recopilar algunos detalles para nuestro equipo. No estimaré precios ni prometo una hora de técnico, pero puedo hacer tu siguiente paso más sencillo.",
      promptProblem:
          ...
          <div className="relative aspect-[.9] overflow-hidden rounded-[2rem] bg-[hsl(var(--primary))]">
            ...
            <div className="absolute bottom-7 left-7 rounded-xl border border-[hsl(var(--background)/.2)] bg-[hsl(var(--primary)/.75)] p-4 backdrop-blur-sm">
              <p className="font-mono-ui text-[9px] uppercase tracking-[.2em] text-[hsl(var(--accent))]">
                Serving Georgia's West Metro Area since
              </p>
